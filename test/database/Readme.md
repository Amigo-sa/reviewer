- файл reviewer_model.py со структурой базы, описанной в виде набора классов pymodm. При импорте этого файла инициируется подключение к базе
- файл sample_data.py для заполнения базы некоторыми значениями
